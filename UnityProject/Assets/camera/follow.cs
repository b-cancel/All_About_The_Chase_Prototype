...
public class follow : MonoBehaviour {
    ...
    void Update () {
        ...
        float newLerp = lerpHelper.calcLerpValueAngle(ourRot.z, objectRot.z, rotationVelocity, wrapType.shortest);   
        gameObject.transform.rotation = Quaternion.Euler(ourRot.x, ourRot.y, Mathf.LerpAngle(ourRot.z, objectRot.z, newLerp));
	}
}
